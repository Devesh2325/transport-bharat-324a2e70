...
import { LayoutDashboard, Inbox, ClipboardList, Wallet, BarChart3, Users, Settings, ShieldCheck, LogOut, Truck, Crown } from "lucide-react";
        ...
        <nav className="flex-1 p-3 space-y-0.5">
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 px-3 py-2 rounded-md text-sm transition-colors ${
                  active ? "bg-sidebar-accent text-sidebar-accent-foreground font-medium" : "hover:bg-sidebar-accent/50 opacity-80 hover:opacity-100"
                }`}
              >
          ...
          {isSuper && (
            <>
              ...
              <Link to="/admin/companies" className={`flex items-center gap-3 px-3 py-2 rounded-md text-sm transition-colors ${loc.pathname.startsWith("/admin") ? "bg-sidebar-accent text-sidebar-accent-foreground font-medium" : "hover:bg-sidebar-accent/50 opacity-80 hover:opacity-100"}`}>
